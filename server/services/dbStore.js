...
export const dbStore = {
  ...
  async createCourse(courseData) {
    const newCourse = {
      ...
      rating: 4.9,
      reviewsCount: 150,
      hours: courseData.hours || 24,
      lessonsCount: courseData.lessonsCount || 10,
      languages: ['English', 'Hindi'],
      techStack: courseData.techStack || ['Web Development'],
      instructorName: courseData.instructorName || 'LearnHub Instructor',
      instructorRole: 'Lead Educator',
      instructorBio: 'Expert industry educator building modern educational content.',
      instructorAvatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCr9CHF12DMyqfTqDPJoBj_xC_FhZnCOV1I6J1SMhxGh9dcJ3yPsxD2HtzKxLTHnyTSpG0uX0MEYSV840HpNX-y1wjUL2W5uzc-jWwkVaS1whPOnE5SxNKOpXId2qBfE-9gu0NTJ6WC0LlVlX-xhbFqOzPgYtHkBVsyxV3NAvnoOITYBeL22R1XVab90baoCu1D0V5K4T5SuN-718WnFxyTEDsfdHu9ezm90n-qADcvPeqDMj_eqNdC',
      ...
      includes: ['Full video lessons', 'Certificate of completion', 'Lifetime access'],
      createdAt: new Date().toISOString(),
    };
