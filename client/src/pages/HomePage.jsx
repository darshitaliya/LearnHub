        ...
        <section className="position-relative py-5 px-3 px-md-5 max-w-container-max mx-auto" style={{ zIndex: 1 }}>
          <div className="row align-items-center g-5">
            ...
            <div className="col-12 col-lg-6 d-none d-md-block position-relative" style={{ minHeight: '500px' }}>
              ...
              {/* Floating Card 1 */}
              <div className="position-absolute glass-panel p-3 rounded-4 glass-card shadow-lg" style={{ top: '10%', left: '-30px', width: '210px', zIndex: 10 }}>
                <div className="d-flex align-items-center gap-2 mb-2">
                  <div className="rounded-circle d-flex align-items-center justify-content-center text-primary" style={{ width: '38px', height: '38px', backgroundColor: 'rgba(79, 70, 229, 0.18)' }}>
              ...
              {/* Floating Card 2 */}
              <div className="position-absolute glass-panel p-3 rounded-4 glass-card shadow-lg" style={{ bottom: '15%', right: '-20px', zIndex: 10 }}>
